...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='checkpoints/llama/2B', help='model name')
...
def main():
    ...
    dataloader, _ = get_loaders(args.calib_dataset, nsamples=args.num_samples, seed=args.seed, model=args.model, seqlen=args.seq_len)
